...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<redis-store>, ["~> 1.2.0"])
      s.add_runtime_dependency(%q<redis-activesupport>, ["~> 5.0.0"])
      s.add_runtime_dependency(%q<redis-actionpack>, ["~> 5.0.0"])
      ...
      s.add_dependency(%q<redis-store>, ["~> 1.2.0"])
      s.add_dependency(%q<redis-activesupport>, ["~> 5.0.0"])
      s.add_dependency(%q<redis-actionpack>, ["~> 5.0.0"])
